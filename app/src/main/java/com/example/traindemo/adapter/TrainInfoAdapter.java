...
public class TrainInfoAdapter extends CursorAdapter {

    private Context mContext;


    public TrainInfoAdapter(Context context, Cursor c, int flags) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        View root = LayoutInflater.from(context).inflate(R.layout.item_train_info, null, false);
        ViewHolder holder = new ViewHolder();
        holder.mTvTrainNo = (TextView) root.findViewById(R.id.id_tv_item_info_no);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.mTvTrainNo.setText("列车车次: " + cursor.getString(cursor.getColumnIndex("train_no")));
