...
import com.example.traindemo.database.TrainProvider;
    ...
    protected void initEvent() {
        mBtnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(start) && !TextUtils.isEmpty(end)) {
                    mCursor = getContentResolver().query(Uri.parse(TrainProvider.TRAIN_URI)
                            , null, "train_starting=? and train_ending=?", new String[]{start, end}, null);
                    mAdapter = new TrainsAdapter(SearchActivity.this, mCursor, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
        ...
        mLvResult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                int train_id = temp.getInt(0);
                //  弹出对话框,列出所有的车票
                Cursor ticketCursor = mTicketDAO.rawQuery("select * from ticket t inner join trains f" +
                        " on t.train_id  = f._id where f._id = ? and t.is_pick = 'false'", new String[]{train_id + ""});
                ...
                mLvTickets.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (mOrdersDAO.insertOrders(values) > 0) {
                            ...
                            Snackbar.make(mLvResult, "添加车票成功!", Snackbar.LENGTH_SHORT).show();
                        }
                        dialog.dismiss();
                    }
                });
