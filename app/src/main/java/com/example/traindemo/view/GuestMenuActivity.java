...
public class GuestMenuActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private int[] mImages = new int[]{
            R.drawable.menu_train_info, R.drawable.menu_ticket, R.drawable.menu_reserve,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (position) {
            ...
            case 2:
                ...
                break;
            case 3:
                switchToActivity(TrainInfoActivity.class);
                break;
        }
    }
    /**
    ...
    private void switchToActivity(Class activity) {
        ...
        intent.putExtra(RegisterActivity.SEND_USER_NAME, mUserName);
